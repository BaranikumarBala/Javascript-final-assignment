...
document.getElementById("cart-count").innerHTML = localStorage.getItem("countValue");
function generateCard(product){
    let card = 
    `
        <div class = "card">
        <a id=${product.id} class = "anchor" href="productdetails.html">
            <div class = "image">
               <img src = ${product.preview} alt = ${product.name} id=${product.id}></img>
            </div>
            <div class = "info">
...
{
  anchor[i].addEventListener("click",pressed);
}
